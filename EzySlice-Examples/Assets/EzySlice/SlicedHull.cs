...
namespace EzySlice {
    ...
    public sealed class SlicedHull {
        ...
        public GameObject CreateUpperHull(GameObject original, Material crossSectionMat) {
            GameObject newObject = CreateUpperHull(original.transform.name);
        ...
        public GameObject CreateLowerHull(GameObject original, Material crossSectionMat) {
            GameObject newObject = CreateLowerHull(original.transform.name); 
            if (newObject != null) {
                newObject.transform.localPosition = original.transform.localPosition;
                newObject.transform.localRotation = original.transform.localRotation;
                newObject.transform.localScale = original.transform.localScale;
        ...
        {
            return CreateEmptyObject("_Upper_Hull", upper_hull);
        }
        public GameObject CreateUpperHull(string name)
        {
            return CreateEmptyObject(name + "_Upper_Hull", upper_hull);
        }
        ...
        {
            return CreateEmptyObject("_Lower_Hull", lower_hull);
        }
        public GameObject CreateLowerHull(string name)
        {
            return CreateEmptyObject(name+"_Lower_Hull", lower_hull);
        }
